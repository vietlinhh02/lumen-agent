...
import { PapersOnboardingTour } from "@/components/onboarding/PapersOnboardingTour";
  ...
  return (
    <div data-tour="papers-welcome" className="px-4 sm:px-6 py-6">
      ...
      <div className="flex flex-col gap-5">
        ...
        {loading ? (
          <div data-tour="papers-table" className="rounded-[12px] bg-surface-card p-6 space-y-3" style={{ border: "1px solid var(--hairline)" }}>
            {[1, 2, 3, 4, 5].map((i) => <div key={i} className="h-12 rounded bg-surface-bone animate-pulse" />)}
          </div>
        ) : (
          <div data-tour="papers-table">
