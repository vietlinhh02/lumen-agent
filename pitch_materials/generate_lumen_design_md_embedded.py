      ...
      <section class="slide thanks">
        ...
        <div class="thanks-card">
          ...
          <div style="margin-top: 0.2in; padding: 0.12in 0.15in; border-radius: 8px; background: var(--surface-bone); border: 1px solid var(--hairline);">
            ...
            <strong style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--ink); margin-top: 5px;">github.com/linhnv-hub/lumen</strong>
          ...
          <div style="margin-top: 0.12in; padding: 0.12in 0.15in; border-radius: 8px; background: var(--surface-bone); border: 1px solid var(--hairline);">
            ...
            <strong style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--ink); margin-top: 5px;">youtu.be/lumen-agent-demo</strong>
          ...
          <div style="margin-top: 0.12in; padding: 0.12in 0.15in; border-radius: 8px; background: var(--surface-bone); border: 1px solid var(--hairline);">
            ...
            <strong style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--ink); margin-top: 5px;">docs.lumen-agent.dev/architecture</strong>
