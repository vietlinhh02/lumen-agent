...
<html lang="vi">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,600;12..96,700;12..96,800&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
      :root {{
        /* Lumen DESIGN.md Design System (Warm Cream AI Lab Notebook - No Orange) */
        --canvas: #f9f7f3;          /* Warm cream canvas from DESIGN.md */
        --surface-bone: #f3f0e8;    /* Bone inset surface from DESIGN.md */
      ...
      * {{
      ...
      .cover {{
        background: radial-gradient(circle at 80% 20%, #f3f0e8 0%, #f9f7f3 70%);
      }}
    ...
    <main class="deck">
      ...
      <section class="slide cover">
        ...
        <div style="max-width: 6.8in;">
          ...
          <p class="tagline">Tự động hóa tổng quan tài liệu học thuật với cơ chế kiểm chứng trích dẫn cấp dòng tuyệt đối</p>
          <p class="lead" style="margin-top: 0.12in;">
            Hệ sinh thái Multi-Agent được phát triển chuyên sâu nhằm triệt tiêu hoàn toàn rủi ro tạo ảo giác nguồn trích dẫn (citation hallucination), tự động hóa việc đọc hiểu, trích xuất cấu trúc dữ liệu PDF phức tạp và lập ma trận so sánh đối chiếu đa tài liệu với 100% trích dẫn được xác thực nguồn.
          </p>
          <div class="metrics" style="margin-top: 0.34in; grid-template-columns: repeat(2, 1fr); gap: 0.14in;">
            <div class="metric"><strong>100%</strong><span>Trích dẫn được xác thực nguồn đến dòng và trang PDF</span></div>
            <div class="metric"><strong>0.0%</strong><span>Ảo giác nguồn trích dẫn (Zero Citation Hallucination)</span></div>
      ...
      <section class="slide thanks">
        ...
        <div class="thanks-card">
          ...
          <div style="margin-top: 0.2in; padding: 0.12in 0.15in; border-radius: 8px; background: var(--surface-bone); border: 1px solid var(--hairline);">
            <span style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 9px; font-weight: 700; text-transform: uppercase; color: var(--charcoal); letter-spacing: 0.5px;">Kho mã nguồn (GitHub Repository)</span>
            <strong style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--ink); margin-top: 2px;">github.com/linhnv-hub/lumen</strong>
            <span style="display: block; font-size: 9.6px; color: var(--charcoal); margin-top: 2px;">Toàn bộ source code Backend (FastAPI), Frontend (React) và LangGraph Workflows</span>
          </div>
          ...
          <div style="margin-top: 0.12in; padding: 0.12in 0.15in; border-radius: 8px; background: var(--surface-bone); border: 1px solid var(--hairline);">
            <span style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 9px; font-weight: 700; text-transform: uppercase; color: var(--charcoal); letter-spacing: 0.5px;">Video Minh họa Tác tử (Demo Screencast)</span>
            <strong style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--ink); margin-top: 2px;">youtu.be/lumen-agent-demo</strong>
            <span style="display: block; font-size: 9.6px; color: var(--charcoal); margin-top: 2px;">Quá trình Agent tự hành tìm kiếm, trích xuất và lập ma trận đối chiếu thời gian thực</span>
          </div>

          <div style="margin-top: 0.12in; padding: 0.12in 0.15in; border-radius: 8px; background: var(--surface-bone); border: 1px solid var(--hairline);">
            <span style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 9px; font-weight: 700; text-transform: uppercase; color: var(--charcoal); letter-spacing: 0.5px;">Tài liệu Kiến trúc & API Specs</span>
            <strong style="display: block; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--ink); margin-top: 2px;">docs.lumen-agent.dev/architecture</strong>
            <span style="display: block; font-size: 9.6px; color: var(--charcoal); margin-top: 2px;">Sơ đồ StateGraph, đặc tả schemas Pydantic và cấu hình Qdrant Vector Index</span>
          </div>
...
print(f"Generated DESIGN.md style HTML at {output_path} ({len(html_content)} bytes)")
