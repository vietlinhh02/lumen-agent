...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,600;12..96,700;12..96,800&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">
    <style>
        :root {
            /* Palette dịu mắt: Midnight Slate & Refined Blue */
            --primary: #2563eb;
        ...
        * {
        ...
        .global-footer.light-text { color: rgba(248, 250, 252, 0.7); }
        ...
        /* Hero Slide: Deep Midnight Slate */
        .hero-slide {
        ...
        .hero-mesh {
            ...
            background: radial-gradient(circle, var(--hero-glow) 0%, rgba(30, 58, 138, 0.4) 45%, transparent 75%);
            filter: blur(140px);
            z-index: 1;
            opacity: 0.9;
            pointer-events: none;
    ...
    <main id="deck-container">
        ...
        <section class="slide hero-slide" id="slide-1">
            ...
            <div class="slide-content">
                <div class="pill-badge pill-dark">PIXTA VIETNAM · ONLINE TEST · BÁO CÁO KỸ THUẬT</div>
        ...
        <section class="slide" id="slide-2">
            <div class="slide-content">
                ...
                <div class="grid-3">
                    ...
                    <div class="card" style="border-left: 3px solid var(--primary); background: #ffffff;">
                        <div class="stat-badge" style="color: #dc2626;">47%</div>
            ...
            <div class="slide-content">
                ...
                <div class="card" style="margin-top: 22px; background: #ffffff; padding: 18px 22px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                        ...
                        <span style="font-family: var(--font-code); font-size: 12.5px; color: var(--primary);">
        ...
        <section class="slide dark-section" id="slide-5">
            <div class="slide-content">
                <div class="pill-badge pill-dark">04 · THIẾT KẾ KIẾN TRÚC AGENT</div>
                ...
                <div class="grid-2-split">
                    ...
                    <div class="code-box">
                        <div style="color: #64748b; margin-bottom: 8px; border-bottom: 1px solid rgba(255,255,255,0.08); padding-bottom: 6px;">
...
workflow.<span class="code-func">add_edge</span>(<span class="code-str">"report_writer"</span>, <span class="code-str">"citation_verifier"</span>)
            ...
            <div class="slide-content">
                ...
                <div class="grid-3">
                    <div class="card" style="border-top: 3px solid #64748b;">
                        <div class="pill-badge" style="background: rgba(100, 116, 139, 0.1); color: #475569;">TẦNG 1 · CHẶN TỪ CỬA VÀO</div>
                    ...
                    <div class="card" style="border-top: 3px solid var(--primary);">
                        <div class="pill-badge pill-primary">TẦNG 2 · MINH BẠCH HÓA</div>
        ...
        <section class="slide hero-slide" id="slide-10">
            <div class="hero-mesh"></div>
            <div class="slide-content">
                <div class="pill-badge pill-dark">TỔNG KẾT &amp; TRAO ĐỔI</div>
                ...
                <div class="grid-3" style="max-width: 1100px; margin-bottom: 32px; z-index: 2; position: relative;">
                    <div class="hero-meta-card" style="background: rgba(30, 41, 59, 0.8);">
                        <div class="label" style="color: #60a5fa; font-weight: 700;">VIDEO TRÌNH DIỄN THỰC TẾ</div>
                        ...
                        <p style="font-size: 12px; color: #94a3b8; margin-top: 4px;">Xem trực tiếp luồng tìm kiếm, tạo ma trận và viết báo cáo</p>
                    </div>

                    <div class="hero-meta-card" style="background: rgba(30, 41, 59, 0.8);">
                        <div class="label" style="color: #60a5fa; font-weight: 700;">MÃ NGUỒN &amp; TÀI LIỆU</div>
                        <div class="val" style="font-size: 14px; margin-top: 6px;">
                            <a href="https://github.com/vietlinhh02" target="_blank" style="color: #ffffff; text-decoration: underline;">
                                github.com/vietlinhh02 ↗
                            </a>
                        </div>
                        <p style="font-size: 12px; color: #94a3b8; margin-top: 4px;">FastAPI Backend + Next.js 16 + 50+ Test Cases</p>
                    </div>

                    <div class="hero-meta-card" style="background: rgba(30, 41, 59, 0.8);">
                        <div class="label" style="color: #60a5fa; font-weight: 700;">SẴN SÀNG PHẢN BIỆN</div>
                        <div class="val" style="font-size: 14px; margin-top: 6px; color: #ffffff;">
                            Trao đổi kỹ thuật chuyên sâu
                        </div>
                        <p style="font-size: 12px; color: #94a3b8; margin-top: 4px;">Sẵn sàng trả lời các câu hỏi về luồng code và tối ưu hệ thống</p>
                    </div>
                </div>

                <div style="z-index: 2; position: relative; font-size: 15px; color: #cbd5e1; line-height: 1.6;">
                    <strong>Nguyễn Viết Linh</strong> · Ứng tuyển: AI Agent Engineer Intern tại PIXTA Vietnam<br>
                    Email: <a href="mailto:nvlinh0607@gmail.com" style="color: #ffffff;">nvlinh0607@gmail.com</a> | Số điện thoại: <strong>0981 601 209</strong>
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        function updateUI() {
            ...
            if (currentSlide) {
                if (currentSlide.classList.contains('hero-slide') || currentSlide.classList.contains('dark-section')) {
...
print(f"Generated humanized presentation successfully: {output_path}")
